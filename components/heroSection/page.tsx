...
const Hero = () => {
  return (
    <section>
      <div className="backG relative py-12 overflow-hidden bg-gray-100 sm:py-16 lg:py-20 xl:py-16">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col justify-center items-center ">
            <div className="foreG max-w-md  mx-auto text-center xl:max-w-xl lg:mx-0 lg:text-center">
              <h1 className="text-3xl font-bold text-gray-50 sm:text-4xl md:text-5xl lg:leading-tight xl:text-6xl">Collect<span className='text-[#51b7ae]'> rare</span> <span className='text-[#51b7ae]'> aesthetic</span> furniture</h1>
              ...
              <div className="inline-grid grid-cols-3 mt-8 gap-x-8">
                <div>
                  <p className="text-4xl font-bold text-gray-300">50k+</p>
                  <p className="mt-2 text-base font-medium text-gray-400">Furniture Sold</p>
                </div>

                <div>
                  <p className="text-4xl font-bold text-gray-300">14k+</p>
                  <p className="mt-2 text-base font-medium text-gray-400">Reviews</p>
                </div>
                <div>
                  <p className="text-4xl font-bold text-gray-300">17k+</p>
                  <p className="mt-2 text-base font-medium text-gray-400">Customers</p>
                </div>
              </div>
            </div>
