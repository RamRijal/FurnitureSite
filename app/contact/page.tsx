                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-12 lg:gap-x-16 xl:gap-x-36">
                    <div className="flex flex-col self-stretch justify-between">
                        ...
                        <div className="grid grid-cols-1 gap-8 mt-12 sm:grid-cols-2 lg:mt-auto">
                            <div>
                                <h3 className="text-xs font-medium tracking-widest text-blue-600 uppercase">USA OFFICE Hours</h3>
                            ...
                            <div>
                                <h3 className="text-xs font-medium tracking-widest text-blue-600 uppercase">Our Address</h3>
                                <p className="mt-5 text-base font-medium text-gray-900">8502 Preston Rd. Ingle, <br />Maine 98380, USA</p>
                            </div>

                            <div>
                                <h3 className="text-xs font-medium tracking-widest text-blue-600 uppercase">Canada Office Hours</h3>
                                <p className="mt-5 text-base font-medium text-gray-900">8502 Preston Rd. Ingle, <br />Maine 98380, USA</p>
                            </div>

                            <div>
                                <h3 className="text-xs font-medium tracking-widest text-blue-600 uppercase">Get In Touch</h3>
                                <p className="mt-5 text-base font-medium text-gray-900">
                                    +1-246-888-0653<br />
                                    +1-222-632-0194
                                </p>
                        ...
                        <div className="p-6 sm:p-10">
                            <form action="#" method="POST" className="space-y-6">
                                <div>
                                    ...
                                    <div className="mt-2">
                                        <input type="text" name="fullName" id="fullName" placeholder="Enter your full name" className="block w-full px-4 py-4 text-base text-gray-900 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600" />
                                    </div>
                                </div>
